 ...
 * @package LydiaCore
 */
class MUser extends Object implements IHasSQL, ArrayAccess, IModule {
   ...
   * Constructor
   */
  public function __construct($qu=null) {
  ...
  public function Save() {
    ...
    $this->SetAuthenticatedUser($this->profile);
  ...
  public function CreatePassword($plain, $algorithm=null) {
    $password = array(
      'algorithm'=>($algorithm ? $algoritm : Questmvc::Instance()->config['hashing_algorithm']),
      'salt'=>null
    );
